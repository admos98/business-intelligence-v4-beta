...
const VendorsDashboard = lazy(() => import('./pages/VendorsDashboard'));
const SummaryDashboard = lazy(() => import('./pages/SummaryDashboard'));
const ItemsDashboard = lazy(() => import('./pages/ItemsDashboard'));
const SellDashboard = lazy(() => import('./pages/SellDashboard'));
const RecipeDashboard = lazy(() => import('./pages/RecipeDashboard'));
const SellAnalysisDashboard = lazy(() => import('./pages/SellAnalysisDashboard'));
...
// Named exports - wrap in default export
const TaxSettingsPage = lazy(() => import('./pages/TaxSettingsPage').then(m => ({ default: m.TaxSettingsPage })));
const TaxReportsPage = lazy(() => import('./pages/TaxReportsPage').then(m => ({ default: m.TaxReportsPage })));
const CustomersPage = lazy(() => import('./pages/CustomersPage').then(m => ({ default: m.CustomersPage })));
const AgingReportsPage = lazy(() => import('./pages/AgingReportsPage').then(m => ({ default: m.AgingReportsPage })));
const AuditLogPage = lazy(() => import('./pages/AuditLogPage').then(m => ({ default: m.AuditLogPage })));
const DataValidationPage = lazy(() => import('./pages/DataValidationPage').then(m => ({ default: m.DataValidationPage })));
