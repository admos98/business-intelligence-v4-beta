    ...
    <>
      ...
      <div className="md:hidden fixed top-0 right-0 z-50 p-4">
        <button
          ...
          className="p-2 bg-surface border border-border rounded-lg hover:bg-border transition-colors"
        >
      ...
      <aside
        className={`fixed md:static inset-y-0 right-0 w-64 bg-surface border-l border-border transition-transform duration-300 z-40 ${
        ...
        <nav className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-border">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-danger/10 text-danger rounded-lg hover:bg-danger/20 transition-colors text-sm font-medium"
            >
              <LogoutIcon />
              خروج
            </button>
