...
import { ShoppingList, ShoppingItem, CafeCategory, Vendor, OcrResult, Unit, ItemStatus, PaymentStatus, PaymentMethod, PendingPaymentItem, SmartSuggestion, SummaryData, RecentPurchaseItem, MasterItem, AuthSlice, User, SettingsSlice, ShoppingState, InflationData, InflationDetail, InflationPoint } from '../types';
...
export const useShoppingStore = create<FullShoppingState>((set, get) => ({
      ...
      logout: () => {
        set({ currentUser: null, ...emptyState, isHydrating: false, githubToken: '', gistId: '' });
      },
