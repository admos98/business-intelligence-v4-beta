...
const ShoppingView: React.FC<ShoppingViewProps> = ({ listId, onBack, onLogout, onOpenSettings }) => {
  ...
  return (
    <div>
      <Header title={list.name} onBack={onBack} backText={t.backToDashboard} onLogout={onLogout} onOpenSettings={onOpenSettings}>
