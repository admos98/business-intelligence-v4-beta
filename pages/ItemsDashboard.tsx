...
const ItemsDashboard: React.FC<ItemsDashboardProps> = ({ onBack, onLogout, onOpenSettings }) => {
  ...
  return (
    <>
      <Header title={t.itemsDashboardTitle} onBack={onBack} backText={t.backToDashboard} onLogout={onLogout} onOpenSettings={onOpenSettings}>
        <button
