...
const InsightsHub: React.FC<InsightsHubProps> = ({ onBack, onLogout, onOpenSettings }) => {
    ...
    return (
        <div className="flex flex-col h-screen">
            <Header title={t.insightsHub} onBack={onBack} backText={t.backToDashboard} onLogout={onLogout} onOpenSettings={onOpenSettings} />
