...
const VendorsDashboard: React.FC<VendorsDashboardProps> = ({ onBack, onLogout, onOpenSettings }) => {
  ...
  return (
    <>
      <Header title={t.vendorsDashboardTitle} onBack={onBack} backText={t.backToDashboard} onLogout={onLogout} onOpenSettings={onOpenSettings}>
        <button
