...
const Dashboard: React.FC<DashboardProps> = ({ onSelectList, onViewAnalysis, onViewVendors, onViewItems, onViewSummary, onLogout, onOpenSettings }) => {
  ...
  return (
    <>
      <Header title={t.appTitle} onLogout={onLogout} onOpenSettings={onOpenSettings}>
         <button
